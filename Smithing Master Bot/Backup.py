...
def Challenge():
    ...
    if locationOfSkipButton is not None:
        ...
        Click(x+20,y+20)
        print("2. Souboj úspìšnì SKIPNUT!")
        sleep(1.5)
    else:
    ...
    if locationOfVictory is not None:
        ...
        Click(x,y)
        print("3. Souboj úspìšnì DOKONÈEN!")
        sleep(1.5)
    else:
...
# Metoda pro hledání Kníek etc. :D- SearchingExtra
...
while keyboard.is_pressed('q') == False:
    # Získání souøadnic rohu okna aplikace
    ...
    #Ujistí se, e se program tøeba jenom nestihl updatnout. Tohle zajišuje, e bude muset všechno checknout ještì jednou
    RUSure = RUSure + 1
    print(RUSure)
    if RUSure != 2:
        continue
    ...
    #Chestky, Pillar
    #Auto chest deployer
    #Memory která bude storovat sealnutı effekty (1,2,3)
    #Nìjaká memory kam se bude storovat poèet chestek

    #TODO!!!
    #Pøidání funkce, aby se to neklikalo mou myší, ale ono samo internì
    #Pøidání funkce, abych to mohl mít pøekryté ostatníma programama a ono to furt fungovalo.

    #Pøidání více funkcí, automatickej crafting, zabíjení bossù, Adventure, Taboo
    #Monost více relací zaráz
